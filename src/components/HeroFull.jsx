...
const HeroFull = () => {
  // URL de una imagen de montaña impactante (puedes cambiarla luego)
  ...
  return (
    // 1. Contenedor principal: Define la altura (h-[80vh] es el 80% de la pantalla) y la imagen de fondo
    <div 
      className="relative bg-cover bg-center h-[80vh] flex items-center"
      style={{ backgroundImage: `url(${bgImage})` }}
    >
      {/* 2. Capa oscura superpuesta (Overlay): Esencial para que el texto se lea */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
          ...
          {/* Usamos un azul más claro (blue-400) para que resalte sobre negro */}
        ...
        <div className="mt-10 flex justify-center gap-4 font-medium">
          ...
          <a
            href="https://wa.me/543874123456?text=Hola!%20Necesito%20asesoramiento%20para%20elegir%20mi%20bici."
            target="_blank"
          ...
          >
            {/* Icono opcional de chat/pregunta */}
